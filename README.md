# WP Bootstrap Navwalker v5 Development
...
**Development branch for v5.0.0 - Please use the v4.3.0 tag for stable version. https://github.com/wp-bootstrap/wp-bootstrap-navwalker/releases/tag/v4.3.0**
